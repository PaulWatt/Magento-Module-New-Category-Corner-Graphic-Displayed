...
class PW_CatCornerGraphic_Catalog_Block_Category_View extends Mage_Core_Block_Template
{
    protected function _prepareLayout()
    {
        ...
        if (!Mage::getStoreConfigFlag('advanced/modules_disable_output/PW_CatCornerGraphic')) {
        
        	$this->getLayout()->getBlock('head')->addCss('catcornergraphic/css/styles.css');
